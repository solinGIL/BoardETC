...
DynaTreeNode.prototype = {
	...
	_getInnerHtml: function() {
		...
		// Checkbox mode
		if( opts.checkbox && data.hideCheckbox !== true && !data.isStatusNode && data.org_type == "user") {
...
//			this.tree.logDebug("dtnode._select(%o) IGNORED - %o", sel, this);
		...
		if( sel ) {
			...
			//선택시 실행 this.data.title
			addUser(this.data.key,this.data.title);
			if( opts.persist ){
			...
			//해제시 실행
			delUser(this.data.key,this.data.title);
			if( opts.persist ){
