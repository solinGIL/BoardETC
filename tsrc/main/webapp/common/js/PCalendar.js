        ...
        strTag += "<table width=\"195\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\" bgcolor=\"#91A2AC\">";
          strTag += "<tr>";
            ...
            strTag += "<select name=\"select4\" style=\"BACKGROUND-COLOR: #FFFFFF; BORDER: #D0D0D0 1 solid; font-family:돋움; font-size:11px; color:#5E5E5E; HEIGHT: 19px\" value=\"25\">";
              strTag += "<option>01시</option>";
              strTag += "<option>02시</option>";
            strTag += "</select>";
            strTag += "<select name=\"select\" style=\"BACKGROUND-COLOR: #FFFFFF; BORDER: #D0D0D0 1 solid; font-family:돋움; font-size:11px; color:#5E5E5E; HEIGHT: 19px\" value=\"25\">";
              strTag += "<option>00분</option>";
              strTag += "<option>05분</option>";
            strTag += "</select></td>";
          strTag += "</tr>";
        strTag += "</table>";
        strTag += "</td>";
...
function Show_cal(sYear, sMonth, sDay) 
{
	...
	Cal_HTML += "<table id=Cal_Table border=0 bgcolor='#f4f4f4' cellpadding=1 cellspacing=1 width=200 onmouseover='parent.doOver(window.event.srcElement)' onmouseout='parent.doOut(window.event.srcElement)' style='font-size : 12;font-family:굴림;'>";
...
function Show_cal_Y(sYear) {
	...
	Cal_HTML += "</head><body>\n";
//	Cal_HTML += "<table id=Cal_Table border=0 bgcolor='#f4f4f4' cellpadding=1 cellspacing=1 width=100% onmouseover='parent.doOver(window.event.srcElement)' onmouseout='parent.doOut(window.event.srcElement)' style='font-size : 12;font-family:굴림;'>\n";
	Cal_HTML += "<table id=Cal_Table border=0 bgcolor='' cellpadding=1 cellspacing=1 width=100% onmouseover='parent.doOver(window.event.srcElement)' onmouseout='parent.doOut(window.event.srcElement)' style='font-size : 12;font-family:굴림;'>\n";
